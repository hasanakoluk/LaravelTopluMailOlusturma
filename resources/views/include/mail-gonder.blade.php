@extends('masters')
@section('title')
    Mail Gönder  Toplu E-Mail Islemleri
@endsection
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Mail Gönder</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="{{route('index')}}"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Mail Gönder</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    @endif
                    <form action="{{route('mail-gonder-post')}}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                <h6 class="mb-0 text-uppercase">Mail Gönder</h6>
                                <hr/>
                                ...
                                <input class="btn btn-success btn-sm mb-3" type="submit" name="ilet" value="Mail Gönder">
