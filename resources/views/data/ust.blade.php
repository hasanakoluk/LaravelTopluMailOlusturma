...
<div class="header-wrapper">
        ...
        <div class="topbar d-flex align-items-center">
            <nav class="navbar navbar-expand">
                <div class="topbar-logo-header">
                    ...
                    <div class="">
                        <h4 class="logo-text">E-Mail İşlemleri</h4>
                    </div>
                </div>
    ...
    <div class="nav-container">
        <div class="mobile-topbar-header">
            ...
            <div>
                <h4 class="logo-text">E-mail işlemleri</h4>
            </div>
        ...
        <nav class="topbar-nav">
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{route('musteri-liste')}}"><i class="bx bx-right-arrow-alt"></i>Müşteri Liste</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li> <a href="{{route('toplu-mail-gonder')}}"><i class="bx bx-right-arrow-alt"></i>Mail Gönder</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;">
                        <div class="menu-title">API Bildirimi</div>
                    </a>
                </li>
            </ul>
        </nav>
